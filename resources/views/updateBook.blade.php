    ...
    <div class="grid grid-cols-[280px_1fr] min-h-screen">
        ...
        <aside class="bg-white border-r border-gray-200 flex flex-col sticky top-0 h-screen">
            ...
            <nav class="flex-1 p-4 flex flex-col gap-2">
                <a href="dashboard-tw.html" class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-primary-green font-medium text-[15px] transition-all duration-150">
                ...
                <a href="books-tw.html" class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg bg-gradient-to-r from-primary-green/10 to-primary-light/10 text-primary-green font-medium text-[15px] relative">
                ...
                <a href="members-tw.html" class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-primary-green font-medium text-[15px] transition-all duration-150">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <a href="loans-tw.html" class="flex items-center gap-3.5 px-4 py-3.5 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-primary-green font-medium text-[15px] transition-all duration-150">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <main class="p-8">
            <!-- Header -->
            <header class="mb-8">
                <h1 class="font-display text-4xl font-semibold text-gray-900 mb-1">update un livre</h1>
                ...
                <form action="{{route('Books.update')}}" method="POST">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl mb-8 shadow-sm">
                        ...
                        <div class="p-8 border-b border-gray-200">
                            ...
                            <p class="text-gray-600 text-[15px]">Remplissez les détails livre</p>
                        </div>
